...
//    torepaint the panel object of frame us req.
    ...
    Server()
    {
        ...
        ImageIcon dp1 =new ImageIcon(ClassLoader.getSystemResource("Icons/DP1.jpeg"));
...
//        functions of frame class
    ...
    {
        new Server();
//        server socket is used to handel server and socket class is used to handel the client side operations
        try{
